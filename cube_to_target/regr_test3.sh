...
./cube_to_target --grid_descriptor_file='../regression-test-data/fv0.9x1.25.nc' \
                 ...
                 --name_email_of_creator 'Peter Hjort Lauritzen, pel@ucar' \
...
/glade/campaign/cesm/cesmdata/cprnc/cprnc -m "$file" ../regression-test-data/fv0.9x1.25_gmted2010_modis_bedmachine_nc0540_Laplace0100_noleak_20260213.nc
