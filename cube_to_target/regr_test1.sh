...
echo $file
/glade/p/cesm/cseg/tools/cprnc/cprnc -m $file ../regression-test-data/ne30pg3_gmted2010_modis_bedmachine_nc0540_Laplace0100_20220608.nc
#/fs/cgd/csm/tools/cprnc/cprnc -m $file ../regression-test-data/ne30pg3_gmted2010_modis_bedmachine_nc0540_Laplace0100_20220608.nc
source plot.sh
