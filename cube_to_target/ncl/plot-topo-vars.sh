...
#set space='\ '
#set title_string="'"'$model' based''"'"#$raw_data' raw data and ''"' #'"'$model ' based on''"'
#set title_string='"'$model' asdf''"'#$raw_data' raw data and ''"' #'"'$model ' based on''"'
#echo $title_string
echo $dataFile
...
ncl  'lmanual_levels=True' 'ldiff=True' 'not_latlon=False' 'area=-1' 'dataFile="../output/fv0.9x1.25-gmted2010_modis-smooth_cam.nc"' 'dataFile2="../output/fv0.9x1.25-gtopo30-smooth_cam.nc"'  'outputFile="gmted2010-minus-gtopo30-fv-0.9x1.25-topo-vars"' 'format="pdf"' 'title_str="GMTED2010 minus GTOPO30"' < plot-topo-vars.ncl
