...
if keyword_set(f_in) then begin
 f = f_in
 if keyword_set(title_in) then title$=title_in
 if not keyword_set(clev) then lev=(findgen(16)-7.99999)*200.
endif else begin
